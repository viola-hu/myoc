...
According to a MYOB internal survey, employees complained that they didn't have enough resources to see a clear career path at the company. In order to enhance MYOB employees' awareness of internal job opportunities and provide the knowledge about how to upskill, our team designed a feature which ideally can be integrated into MYOB's exisiting employee system.
...
Collaborating with designers and other developers in New Zealand team, I was mainly focusing on the front end, building the User Profile page where users can select current skillsets.
